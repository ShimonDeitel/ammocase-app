...
final class AmmocaseUITests: XCTestCase {
    ...
    func testAddFlow() {
        ...
        nameField.tap()
        nameField.typeText("UI Test Lot")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["UI Test Lot"].waitForExistence(timeout: 2))
    }
